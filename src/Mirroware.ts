...
const scene = [
    ...
    //{ type : 'Circle', info:[{ x : 17, y : 17 },1,  0.3,'0,255,0' ]},
    //{ type : 'Circle', info:[{ x : 17, y : 17 }, 0.5,  0.3,'0,0,255' ]},
    ...
    //{ type:'Wall', info:[[15, 13],[15, 20],  1, '0,155,200'       ]},
    
    //{ type:'Wall', info:[[8, 16],[8, 17.95],  1, '0,0,200'       ]},

    
    { type:'Wall', info:[[15, 15],[15, 14],  1, '0,100,100'     ]},

    //{ type:'Wall', info:[[15, 13],[15, 20],  1, '0,155,20d0'       ]},


    { type:'Wall', info:[[7, 20],[15, 20],  0.3, '255,46,87'      ]},
    { type:'Wall', info:[[7, 15],[15, 15],  0.3, '0,100,100'   ]},
    //{ type:'Wall', info:[[7, 19],[9, 19],  0.8, '100,0,0'   ]},
    ...
    { type:'Wall', info:[[19, 12],[22, 12],  0.9, '0,255,100'   ]},
    { type:'Wall', info:[[19, 15],[22, 15],  0.9, '0,255,100'   ]},
    { type:'Wall', info:[[22, 12],[22, 15],  0.9, '255,157,0'     ]},
    { type:'Wall', info:[[19, 12],[19, 15],  0.9, '255,157,0'     ]},
