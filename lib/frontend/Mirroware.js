...
const scene = [
    ...
    { type: 'Wall', info: [[5, 5], [5, 25], 0.5, '255,255,0'] },
    { type: 'Wall', info: [[10, 5], [10, -20], 0.5, '0,255,0'] },
    { type: 'Wall', info: [[12, 5], [12, -20], 0.5, '255,0,0'] },
    ...
    { type: 'Wall', info: [[7, 20], [15, 20], 0.8, '255,46,87'] },
    { type: 'Wall', info: [[7, 15], [15, 15], 0.8, '0,100,100'] },
    { type: 'Wall', info: [[7, 19], [15, 19], 0.8, '255,46,87'] },
    { type: 'Wall', info: [[7, 14], [15, 14], 0.8, '0,100,100'] },
    { type: 'Wall', info: [[15, 15], [15, 14], 0.8, '0,100,100'] },
    { type: 'Wall', info: [[15, 19], [15, 20], 0.8, '255,46,87'] },
    ...
    { type: 'Wall', info: [[19, 12], [22, 12], 1, '0,255,100'] },
    { type: 'Wall', info: [[19, 15], [22, 15], 1, '0,255,100'] },
