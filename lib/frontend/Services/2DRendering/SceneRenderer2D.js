...
class SceneRenderer2D extends Service {
    ...
    renderWall(wall) {
        ...
        __classPrivateFieldGet(this, _SceneRenderer2D_context, "f").lineWidth = 20;
    ...
    renderRay(ray, source) {
        ...
        __classPrivateFieldGet(this, _SceneRenderer2D_context, "f").strokeStyle = 'rgba(255,255,255,0.05)';
        __classPrivateFieldGet(this, _SceneRenderer2D_context, "f").lineWidth = 80;
