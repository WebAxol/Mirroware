...
var _RayCalculator_chief;
import Service from "../Service.js";
class RayCalculator extends Service {
    constructor(chief) {
        super();
        _RayCalculator_chief.set(this, void 0);
        __classPrivateFieldSet(this, _RayCalculator_chief, chief, "f");
    }
    execute() {
    ...
    calculateRayProperties() {
        const raySources = __classPrivateFieldGet(this, _RayCalculator_chief, "f").world.getCollection('RaySources');
...
_RayCalculator_chief = new WeakMap();
