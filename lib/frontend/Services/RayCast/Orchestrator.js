...
class RayCaster extends Service {
    constructor() {
        ...
        _RayCaster_variableCalculator.set(this, void 0); // Calculates required variables for the raycasting algorithm
        _RayCaster_rayCastProcessor.set(this, void 0); // Uses previously calculated variables to perform the raycast algorithm
