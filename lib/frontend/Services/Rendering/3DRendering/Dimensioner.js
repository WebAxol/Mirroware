...
class Dimensioner extends Service {
    ...
    calculateChunkDimensions(sceneChunk, prevDistance = 0, adjustment = undefined) {
        ...
        function calculateRayDetails(ray, prevDistance = 0, adjustment = 1) {
    ...
    interpolateDetails(detailA, detailB) {
    }
}
